...
import com.BookLine.HibernateDAO.ContactDAO;
import com.BookLine.Pojo.Contact;
import com.BookLine.Validator.ContactFormValidator;

@Controller
public class ContatsControllers {
	@Autowired
	...
	{
		ModelAndView mav = new ModelAndView("showContacts");
		List<Contact> contacts = contactsDAO.getAllContact();
